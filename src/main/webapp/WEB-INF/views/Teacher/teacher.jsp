...
<head>
    ...
    <script type="text/javascript">
        ...
        var TableInit = function () {
            ...
            oTableInit.Init = function () {
                $('#tb_departments').bootstrapTable({
                    url: '/teacher/getTeacher', //请求后台的URL（*）
                    method: 'post', //请求方式（*）
        ...
        function delFormatter(value,row,index) {
            return '<button type="button" class="btn btn-primary btn-sm" onclick="updateTeacher(\''+row.id+'\')">修改</button>';

        }

        function updateTeacher(id){
            window.location.href="../teacher/toInfo?id="+id;
        }
        ...
        function del() {
            ...
            $.ajax({
                ...
                success : function(result1) {
                    if (result1.result==1){
                        alert("删除成功");
                        window.location.href = "/teacher/toTeacherPage";
                    }else{
                        alert("删除失败");
                    }
                },
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form" method="post" action="/teacher/insert">
